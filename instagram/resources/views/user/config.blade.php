                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('user.update') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ \Illuminate\Support\Facades\Auth::user()->surname }}" required autocomplete="surname" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" name="nick" value="{{ \Illuminate\Support\Facades\Auth::user()->nick }}" required autocomplete="nick" autofocus>
